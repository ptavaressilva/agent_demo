"""Long-term memory: durable, cross-session state about a keyed entity.
...
and written across many separate sessions. Shared infrastructure any agent
may use; not enforced by the platform the way kill switch/tracing/gateway are.
